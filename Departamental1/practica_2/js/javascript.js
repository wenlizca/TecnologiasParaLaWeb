...
//BASE DE DATOS
 var productos = ["Laptop Lenovo IdeaPad S145-14IGM / Intel Celeron / 14 Pulg. / 500gb / 4gb RAM / Gris", "Grafica", "Disco duro", "Ordenador", "Bolso portatil", "Portatil", "Memoria RAM", "Router Linux", "Sintonizadora TV"];
 ...
 var precios = [8000, 169, 36, 360, 11, 540, 21, 66, 25];
 var stock = [2, 2, 8, 3, 10, 4, 3, 1, 2];
 var precioTransporte = [150, 12, 20, "gratis"];
 var IVA = 0.18;
 var uniUser;
