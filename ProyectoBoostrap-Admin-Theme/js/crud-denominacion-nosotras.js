...
function ActionCreate(){
    ...
    var eje_local     = document.getElementById("creareje").value;
    var crearmodalidad_local   = document.getElementById("crearmodalidad").value;
    var creardescripcion_local      = document.getElementById("creardescripcion").value;
    var crearfactor_local         = document.getElementById("crearfactor").value;
    var crearejemplos_local = document.getElementById("crearejemplos").value;
    var id;
    ...
    $.ajax({
        ...
        data: {
            ...
            eje_tematico       : eje_local,
            modalidad           : crearmodalidad_local,
            descripcion       : creardescripcion_local,
            factor           : crearfactor_local,
            ejemplos         : crearejemplos_local, 
            accion          : 'Create'
        },
